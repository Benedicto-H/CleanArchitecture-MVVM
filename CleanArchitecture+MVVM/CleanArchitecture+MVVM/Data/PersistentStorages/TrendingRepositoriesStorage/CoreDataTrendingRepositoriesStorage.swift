...
final class CoreDataTrendingRepositoriesStorage {
    ...
    private func deleteTrendingRepositoriesPageDto(in context: NSManagedObjectContext) -> Void {
...
extension CoreDataTrendingRepositoriesStorage: TrendingRepositoriesStorage {
    ...
    func getTrendingRepositoriesPageDto(completion: @escaping (Result<TrendingRepositoriesStorageItem?, any Error>) -> Void) {
