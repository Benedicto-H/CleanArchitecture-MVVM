...
final class CoreDataImagesStorage {
    ...
    /// Using LRU logic
    static let maxSizeInBytes = 200 * 1000000   //  200MB
    ...
    private func deleteImage(for urlPath: String, in context: NSManagedObjectContext) -> Void {
    ...
    static func removeLeastRecentlyUsedImages() -> Void {
...
extension CoreDataImagesStorage: ImagesStorage {
    ...
    func save(imageData: Data, for urlPath: String) -> Void {
