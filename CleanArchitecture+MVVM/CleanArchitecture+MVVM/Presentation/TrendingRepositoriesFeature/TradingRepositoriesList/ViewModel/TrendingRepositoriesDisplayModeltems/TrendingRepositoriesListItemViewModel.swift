...
extension TrendingRepositoriesListItemViewModel {
    init(repository: Repository) {
        self.repository = RepositoryItemViewModel(id: repository.id,
                                                  owner: RepositoryOwnerItemViewModel(name: repository.owner.name,
...
private extension Repository {
    var languageColor: UIColor? {
        get {
            ...
            case "TypeScript": return .systemOrange
