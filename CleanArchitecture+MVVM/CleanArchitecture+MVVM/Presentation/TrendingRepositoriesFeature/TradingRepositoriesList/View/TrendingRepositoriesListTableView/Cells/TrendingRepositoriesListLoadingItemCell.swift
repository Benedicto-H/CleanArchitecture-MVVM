//
//  TrendingRepositoriesListLoadingItemCell.swift
...
final class TrendingRepositoriesListLoadingItemCell: UITableViewCell, SkeletonLoadable {
    ...
    private lazy var horizontalStack: UIStackView = {
        let stack = UIStackView(arrangedSubviews: [ownerNameLabel, repositoryNameLabel])
    ...
    private func setupViewLayout() -> Void {
        ...
        NSLayoutConstraint.activate([
            ...
            horizontalStack.leadingAnchor.constraint(equalTo: ownerImageView.trailingAnchor, constant: Constants.horizontalSpaceBetweenImageAndTextContent),
    ...
    override func layoutSubviews() {
        ...
        ownerImageLayer.frame = CGRect(origin: .zero, size: CGSize(width: ownerImageView.bounds.width,
                                                                   height: ownerImageView.bounds.height))

        ownerNameLayer.frame = CGRect(origin: .zero, size: CGSize(width: ownerNameLabel.bounds.width / 3,
                                                                  height: ownerNameLabel.bounds.height))
        
        repositoryNameLayer.frame = CGRect(origin: .zero, size: CGSize(width: repositoryNameLabel.bounds.width / 2,
