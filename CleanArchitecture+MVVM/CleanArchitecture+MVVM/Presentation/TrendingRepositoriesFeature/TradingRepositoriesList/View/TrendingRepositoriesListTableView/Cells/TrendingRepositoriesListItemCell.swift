//
//  TrendingRepositoriesListItemCell.swift
...
final class TrendingRepositoriesListItemCell: UITableViewCell {
    ...
    private lazy var horizontalStack: UIStackView = {
        let stack = UIStackView(arrangedSubviews: [ownerNameLabel, repositoryNameLabel, repositoryDetailsStack])
    ...
    private lazy var repositoryDetailsStack: UIStackView = {
        let stack = UIStackView(arrangedSubviews: [repositoryDescriptionLabel, repositoryLanguageAndStartsStack])
    ...
    private lazy var repositoryLanguageAndStartsStack: UIStackView = {
        let stack = UIStackView(arrangedSubviews: [repositoryLanguageStack, repositoryStartsStack, rightLanguageAndStarsSpace])
    ...
    private lazy var repositoryLanguageStack: UIStackView = {
        let stack = UIStackView(arrangedSubviews: [repositoryLanguageColorView, repositoryLanguageLabel])
    ...
    private lazy var repositoryStartsStack: UIStackView = {
        let stack = UIStackView(arrangedSubviews: [repositoryStarImageView, repositoryStarsLabel])
    ...
    private let repositoryStarImageView: UIImageView = {
        let image = UIImage(named: Images.Common.Icons.star)?.withRenderingMode(.alwaysTemplate)
    ...
    private func setupViewLayout() -> Void {
        ...
        NSLayoutConstraint.activate([
            ...
            horizontalStack.leadingAnchor.constraint(equalTo: ownerImageView.trailingAnchor,
        ...
        rightLanguageAndStarsSpace.setContentCompressionResistancePriority(.fittingSizeLevel, for: .horizontal)
    }
    ...
    internal func configure(with model: TrendingRepositoriesListItemViewModel, imagesRepository: ImagesRepository) -> Void {
        ...
        updateOwnerImage(imagesRepository: imagesRepository, imageUrl: model.repository.owner.avatarUrl)
    }
    
    private func updateOwnerImage(imagesRepository: ImagesRepository, imageUrl: String) -> Void {
